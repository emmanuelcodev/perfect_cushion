...
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = '8ax=n_r@*u)f9ax%ez#no^jn8n9$l$yn5z#02_%tvnv8-irj6q'
...
#explanation of static https://stackoverflow.com/questions/24022558/differences-between-staticfiles-dir-static-root-and-media-root
